...
/**
 * Simpan hasil stroke recognition dari kanvas user.
 * Browser-side dah hitung score + metric — server cuma persist + return id.
 */
class StrokeAttemptController extends Controller
{
    /** `POST /api/strokes/attempts` — simpan attempt. */
    ...
    /** `GET /api/strokes/attempts?aksara_id=X` — list attempts user. */
