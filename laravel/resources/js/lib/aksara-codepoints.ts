// Aksara Bali codepoint registry — single source of truth.
// Tidak ada character literal aksara di kode lain — selalu pakai glyph(CP.xxx).
//
// Sumber: standar Unicode Balinese block (U+1B00..U+1B7F).
// Ref: https://www.unicode.org/charts/PDF/U1B00.pdf
// Rendering visual via Noto Sans Balinese (lihat app.blade.php).
...
export type CodePoint = (typeof CP)[keyof typeof CP];
...
// Pangangge standalone dengan dotted-circle prefix sbg placeholder konsonan.
