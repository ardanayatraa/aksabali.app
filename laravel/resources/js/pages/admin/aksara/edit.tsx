    ...
    return (
        <AdminLayout>
            ...
            <section className="mt-4">
                <p className="text-xs font-black uppercase tracking-[0.22em] text-primary">{isNew ? 'Tambah' : 'Edit'}</p>
                <h1 className="mt-2 font-display text-3xl font-semibold leading-tight tracking-tight">
                    {isNew ? 'Aksara baru.' : aksara!.name}
                </h1>
            </section>

            <form onSubmit={submit} className="mt-6 grid gap-6 rounded-3xl border border-border bg-card p-6 sm:p-8 lg:grid-cols-2">
                <div>
                    ...
                    <input
                        ...
                        disabled={!isNew}
                        className="mt-2 w-full rounded-lg border border-border bg-background px-4 py-2.5 text-sm font-mono focus:border-primary focus:outline-none disabled:opacity-60"
                ...
                <div>
                    ...
                    <input
                        ...
                        maxLength={8}
                    />
                    <p className="mt-1 text-xs text-muted-foreground">Paste atau ketik karakter Unicode Bali langsung.</p>
                </div>
                ...
                <div className="lg:col-span-2">
                    ...
                    <input
                        ...
                        className="mt-2 w-full rounded-lg border border-border bg-background px-4 py-2.5 text-sm font-mono focus:border-primary focus:outline-none"
